...
exports.extractP0i = exports.P0I_EXTRACTOR_ID = void 0;
const confidence_score_1 = require("../types/confidence-score");
const extractor_types_1 = require("./extractor.types");
exports.P0I_EXTRACTOR_ID = "extractor.p0i";
const ADRESSE_RE = /\b(?:adresse|situation\s+du\s+bien|d[ée]signation\s+du\s+bien)\s*:?\s*([^\n;|]{8,120})/i;
const DATE_RE = /\b(?:date\s+(?:de\s+)?(?:vente|acquisition|acte))\s*:?\s*(\d{1,2}[/.-]\d{1,2}[/.-]\d{2,4}|\d{4}[/.-]\d{1,2}[/.-]\d{1,2})\b/i;
    ...
    async extract(context) {
        ...
        if (adresseMatch) {
            ...
            fields.push({
                ...
                confidence: (0, confidence_score_1.createConfidenceScore)(0.76, ["adresse:label"]),
        ...
        if (dateMatch) {
            ...
            fields.push({
                ...
                confidence: (0, confidence_score_1.createConfidenceScore)(0.74, ["date:regex"]),
        ...
        if (priceMatch) {
            ...
            if (data.salePrice !== undefined) {
                ...
                fields.push({
                    ...
                    confidence: (0, confidence_score_1.createConfidenceScore)(0.72, ["price:regex"]),
        ...
        if (surfaceMatch) {
            ...
            if (data.surfaceM2 !== undefined) {
                ...
                fields.push({
                    ...
                    confidence: (0, confidence_score_1.createConfidenceScore)(0.7, ["surface:regex"]),
        ...
        const avgConfidence = fields.length > 0
            ...
            : 0;
        const needsReview = fields.length === 0 ||
            avgConfidence < confidence_score_1.CONFIDENCE_THRESHOLDS.review ||
            !data.adresseEtablissement;
        const result = {
            documentType: "p0i",
            extractorId: exports.P0I_EXTRACTOR_ID,
            fields,
            data,
            confidence: (0, confidence_score_1.createConfidenceScore)(avgConfidence, factors),
            needsReview,
