...
Définir de manière unique le champ "Terrasse".
...
Le champ Terrasse indique si le bien dispose d'une terrasse privative rattachée au lot principal.

Cette information permet de caractériser le bien et pourra être utilisée dans de futures analyses patrimoniales, de valorisation et de contrôle de cohérence.
...
**"Le bien dispose-t-il d'une terrasse ?"**
...
Aide : Le bien dispose-t-il d'une terrasse ?
...
- Déduire automatiquement la présence d'une terrasse sans justification.