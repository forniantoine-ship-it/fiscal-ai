...
export function PendingAmountRow({
  ...
  return (
    <li className="flex flex-col gap-3 bg-emerald-500/[0.04] px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div className="flex shrink-0 items-center gap-3">
        ...
        <div className="flex gap-2">
          <button
            type="button"
            onClick={onConfirm}
            className="rounded-full bg-emerald-500 px-3 py-1.5 text-xs font-semibold text-zinc-950 hover:bg-emerald-400"
          >
            Confirmer
          </button>
          <button
            type="button"
            onClick={onCorrect}
            className="rounded-full px-3 py-1.5 text-xs font-medium text-zinc-300 ring-1 ring-white/15 hover:bg-white/5"
          >
            Corriger
          </button>
        </div>
