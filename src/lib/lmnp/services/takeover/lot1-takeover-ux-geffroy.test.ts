...
/** 22 candidats GEFFROY (hors sortie B71200) avec comptes PCG documentaires. */
const GEFFROY_ROWS: GeffroyRow[] = [
  ...
  { key: "B80700", label: "LA PLATEFORME karcher novipro", gross: 529, cumul: 470.81, startDate: "2018-07-19", durationYears: 5, method: "lineaire", pcg: "21540000" },
  { key: "B81100", label: "ZOLPAN echaffaudage", gross: 1125, cumul: 919.37, startDate: "2018-11-30", durationYears: 5, method: "lineaire", pcg: "21540000" },
  { key: "B90100", label: "ZOLPAN graco pisto", gross: 1506.85, cumul: 1182.88, startDate: "2019-01-28", durationYears: 5, method: "lineaire", pcg: "21540000" },
  { key: "B91100", label: "ZOLPAN planex lhs 225", gross: 1449, cumul: 894.35, startDate: "2019-11-30", durationYears: 5, method: "lineaire", pcg: "21540000" },
  { key: "C01000", label: "Défonceuse OF 1010 EBQ-Plus", gross: 570.9, cumul: 249.29, startDate: "2020-10-25", durationYears: 5, method: "lineaire", pcg: "21540000" },
  { key: "C01001", label: "Fraiseuse Df 500 Q set DOMINO", gross: 886.75, cumul: 387.21, startDate: "2020-10-25", durationYears: 5, method: "lineaire", pcg: "21540000" },
  { key: "C01100", label: "Scie semi stationnaire CS 50 E", gross: 880, cumul: 367.16, startDate: "2020-11-30", durationYears: 5, method: "lineaire", pcg: "21540000" },
  { key: "C01101", label: "Table mobile de sciage", gross: 854.4, cumul: 356.47, startDate: "2020-11-30", durationYears: 5, method: "lineaire", pcg: "21540000" },
  { key: "C11200", label: "Lève plaque de platre", gross: 598.55, cumul: 129.02, startDate: "2021-12-03", durationYears: 5, method: "lineaire", pcg: "21540000" },
  { key: "C20700", label: "scie à onglets", gross: 643.03, cumul: 61.45, startDate: "2022-07-09", durationYears: 5, method: "lineaire", pcg: "21540000" },
  { key: "C30300", label: "pONCEUSE EXCENTRIQUE ETS EC150", gross: 507.38, cumul: "missing", startDate: "2023-03-23", durationYears: 5, method: "lineaire", pcg: "21540000" },
  { key: "C31000", label: "SCIE A ONGLET RADIALE KAPEX", gross: 666.89, cumul: "missing", startDate: "2023-10-02", durationYears: 5, method: "lineaire", pcg: "21540000" },
  { key: "C40200", label: "PONCEUSE ROTO EXCENTRIQUE RO", gross: 591.88, cumul: "missing", startDate: "2023-02-22", durationYears: 5, method: "lineaire", pcg: "21540000" },
  { key: "B80200", label: "PEUGEOT EXPERT VU", gross: 9500, cumul: 9246.66, startDate: "2018-02-19", durationYears: 5, method: "lineaire", pcg: "21820000" },
  { key: "B90800", label: "RENAULT TRAFIC EE-286-XG", gross: 7799.37, cumul: 5212.56, startDate: "2019-08-28", durationYears: 5, method: "lineaire", pcg: "21820000" },
  { key: "C10200", label: "MASTER III EY-332-ND RENAULT", gross: 15668.24, cumul: 5945.23, startDate: "2021-02-08", durationYears: 5, method: "lineaire", pcg: "21820000" },
  { key: "C00900", label: "PC portable HP spectrex360", gross: 1832.91, cumul: 1398.44, startDate: "2020-09-17", durationYears: 3, method: "lineaire", pcg: "21830000" },
  { key: "C11100", label: "APPLE MACBOOK", gross: 999.99, cumul: 371.29, startDate: "2021-11-20", durationYears: 3, method: "lineaire", pcg: "21830000" },
  { key: "C21100", label: "APPLE ORDINATEUR", gross: 1540.83, cumul: 67.05, startDate: "2022-11-14", durationYears: 3, method: "lineaire", pcg: "21830000" },
  { key: "C21200", label: "IPHONE 14 APPLE", gross: 1340.83, cumul: 22.35, startDate: "2022-12-13", durationYears: 3, method: "lineaire", pcg: "21830000" },
];
